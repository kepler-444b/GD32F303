...
#define PC0  DEFINE_GPIO(GPIOC, GPIO_PIN_0)
#define PD1  DEFINE_GPIO(GPIOD, GPIO_PIN_1)
#define PD0  DEFINE_GPIO(GPIOD, GPIO_PIN_0)
#define PD9  DEFINE_GPIO(GPIOD, GPIO_PIN_9)
#define PD10 DEFINE_GPIO(GPIOD, GPIO_PIN_10)

#define PE15 DEFINE_GPIO(GPIOE, GPIO_PIN_15)
